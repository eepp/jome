...
Params parseArgs(QApplication& app)
{
    ...
    const QCommandLineOption copyOpt {"x", "Copy the emoji to the clipboard"};
    ...
    params.copy = parser.isSet(copyOpt);
...
int main(int argc, char **argv)
{
    ...
    QObject::connect(&win, &jome::QJomeWindow::emojiChosen,
        ...
        if (params.copy) {
            QGuiApplication::clipboard()->setText(QString::fromStdString(emojiStr).trimmed());
        }
